...
*
*/
void execute_process(process *process_to_execute, int foreground, int parallel){

	//if the mode of execution is foreground and the command is internal, done
	if (foreground && execute_internal_command(process_to_execute -> args)) return;
